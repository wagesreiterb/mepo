"""
Django settings for mepo project.
...
SECRET_KEY = '(fst)5_g+rxm9hjrdm&d=gxn&3w@pit=gaqzi+m)qp(xl*!#c4'
...
# redirect after login was successful
...
WSGI_APPLICATION = 'mepo.wsgi.application'
